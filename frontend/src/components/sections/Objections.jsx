...
export default function Objections() {
  return (
    <section data-testid="objections-section" className="relative py-24 sm:py-32 bg-white border-y border-ink/10">
        ...
        <div className="mt-14 divide-y divide-ink/15 border-y border-ink/15">
          {items.map((it, i) => (
            <div
              ...
              className="grid md:grid-cols-12 gap-4 py-8 group hover:bg-cream-100 transition-colors px-4 -mx-4"
            >
              <div className="md:col-span-1 font-mono text-sm text-muk pt-1">
                /{String(i + 1).padStart(2, "0")}
              </div>
              <div className="md:col-span-5 font-anton text-2xl sm:text-3xl text-ink">
                {it.q}
              </div>
              <div className="md:col-span-6 text-lg text-ink/80 md:text-right">
